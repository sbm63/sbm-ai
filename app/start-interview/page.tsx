      ...
      <div className="custom-screen py-8">
        <div className="card max-w-md mx-auto">
          <div className="card-body text-center py-12">
            ...
            <p className="text-red-600 font-medium">{error || 'Candidate not found.'}</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="max-w-4xl mx-auto">
        <div className="page-header">
          <div>
            ...
            <p className="page-subtitle">Configure and begin the interview process</p>
          </div>
          <button
              ...
              <div className="card-body space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-center text-gray-600">
                    ...
                    <a href={`mailto:${candidate.email}`} className="hover:text-indigo-600 transition-colors">
                      {candidate.email}
                    </a>
                  </div>
                  {candidate.phone && (
                    <div className="flex items-center text-gray-600">
                      ...
                      <a href={`tel:${candidate.phone}`} className="hover:text-indigo-600 transition-colors">
                        {candidate.phone}
                      </a>
                    </div>
                  )}
            ...
            <div className="card">
              ...
              <div className="card-body space-y-6">
                <div>
                  ...
                  >
                    <option value="">
                      {profilesLoading ? 'Loading profiles…' : 'Select a job profile'}
                    </option>
                    {profiles.map((p) => (
